...
<div id="confirm-subscription-app">
  ...
  <div class="confirm-subscription-container" v-if="!loading && !error">
    <SummaryPanel :priceCents="priceCents" :period="period" />
